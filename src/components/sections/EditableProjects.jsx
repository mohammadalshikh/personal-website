...
const EditableProjects = ({ projects = [], onChange }) => {
    ...
    if (projects.length === 0) {
        return <p className="editable-projects-empty">No projects yet. Click + to add one.</p>;
    }

    return (
        <div className="editable-projects-container">
            {projects.map((project, index) => (
                <EditableCard
                    ...
                    onDrop={handleDrop}
                >
                    <div className="editable-projects-card">
                        <input
                            type="text"
                            value={project.name}
                            onChange={(e) => handleFieldChange(index, 'name', e.target.value)}
                            className="editable-projects-name-input"
                        ...
                        <textarea
                            ...
                            className="editable-projects-description-textarea"
                            rows="3"
                            placeholder="Description"
                        />

                        <div className="editable-projects-technologies-wrapper">
                            <label className="editable-projects-technologies-label">Technologies</label>
                            <input
                                type="text"
                                ...
                                className="editable-projects-technologies-input"
                                placeholder="Python,React"
                            />
                        </div>

                        {Array.isArray(project.technologies) && project.technologies.length > 0 && (
                            <div className="editable-projects-technologies-preview">
                                {project.technologies.map((tech, idx) => (
                                    <span key={idx} className="editable-projects-tech-tag">
                                        {tech}
                                    </span>
                                ))}
                            </div>
                        ...
                        <div className="editable-projects-urls-wrapper">
                            <input
                                ...
                                className="editable-projects-url-input"
                        ...
                        <div className="editable-projects-links">
                            {project.link && (
                                <a
                                    href={project.link}
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="editable-projects-link"
                                >
                                    <svg className="editable-projects-link-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            {project.github && (
                                <a
                                    ...
                                    className="editable-projects-link"
                                >
                                    <svg className="editable-projects-link-icon" fill="currentColor" viewBox="0 0 24 24">
